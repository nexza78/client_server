...
export class App extends React.Component {
  ...
  WriteTopic(){
    ...
    <div className="App">
      ...
      <ul className="positionButtons"> <p><button onClick={() =>this.assistant.close()} className ="second_button">Выход</button></p></ul>
      <ul className="positionButtons"> <p><button onClick={() =>this.assistant_global_event("show_res")} className ="fourth_button">Результаты</button></p></ul>
    </div>)
  }
  ShowTopics() {
    this.setState({state: 0});
